  ...
  const jsonLd = [
    {
      ...
      author: { '@type': 'Organization', name: 'CanopyShield Insurance Services', url: 'https://canopyshield.com' },
      publisher: { '@type': 'Organization', name: 'CanopyShield Insurance Services', url: 'https://canopyshield.com' },
      description: resource.metaDescription,
      url: `https://canopyshield.com/cannabis/resources/${resource.slug}/`,
    },
