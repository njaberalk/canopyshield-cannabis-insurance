...
export default async function CityPage({ params }) {
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', '@id': `https://canopyshield.com/cannabis/cities/${city.slug}/`, name: 'CanopyShield Insurance Services', url: 'https://canopyshield.com', telephone: '+18559255363', email: 'info@canopyshield.com', areaServed: { '@type': 'City', name: city.city, containedInPlace: { '@type': 'State', name: city.state } }, priceRange: '$$' }) }} />
