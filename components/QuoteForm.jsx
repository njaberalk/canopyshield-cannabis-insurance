      ...
      <div ref={ref} className="max-w-[68rem] mx-auto px-[60px] max-lg:px-6 max-md:px-4 fade-in-view">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative overflow-hidden rounded-[2rem]" style={{ minHeight: '400px' }}>
            <img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=800&q=80" alt="Cannabis dispensary interior" width={800} height={600} className="absolute inset-0 w-full h-full object-cover" style={{ filter: 'grayscale(100%)' }} />
